...
if($_SESSION["perfil"] == "Administrador" || $_SESSION["perfil"] == "Encargado" || $_SESSION["perfil"] == "Mecanico"){
  ...
  echo '<li class="active treeview">
        ...
        if($_SESSION["perfil"]=="Administrador" || $_SESSION["perfil"] == "Encargado"){
         echo '<li class="active"><a href="categorias"><i class="glyphicon glyphicon-th-list"></i> Categorias</a></li>';
        }
            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      if($_SESSION["perfil"] == "Administrador"){
                       ...
                       echo '<button class="btn btn-warning btnEditarCategoria" idCategoria="'.$value["id_categoria"].'" data-toggle="modal" data-target="#modalEditarCategoria"><i class="fa fa-pencil"></i></button>
